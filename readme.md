...
[![Live Demo](https://img.shields.io/badge/Live_Demo-hhg__rag.vercel.app-00ffaa?style=for-the-badge&logo=vercel&logoColor=black)](https://hhg-rag.vercel.app)
[![GitHub Repo](https://img.shields.io/badge/GitHub-hacker__house__goa-00d9ff?style=for-the-badge&logo=github&logoColor=white)](https://github.com/prasadaniket/hhgoa_task_2)
[![Event](https://img.shields.io/badge/Hacker_House_Goa-2026-ff6b35?style=for-the-badge)](https://hhgoa.com/)
[![Latency SLA](https://img.shields.io/badge/Latency_Budget-<200ms_SLA-00ffaa?style=for-the-badge)](https://hhg-rag.vercel.app)
[![Dataset](https://img.shields.io/badge/Dataset-MSMARCO--XI_(241k_chunks)-14b8a6?style=for-the-badge)](https://huggingface.co/datasets/ai4bharat/MSMARCO-XI)
[![License](https://img.shields.io/badge/License-MIT-94a89c?style=for-the-badge)](LICENSE)

---

## 🔗 Quick Links & Live Deployments

- 🌐 **Live Web Application**: [hhg-rag.vercel.app](https://hhg-rag.vercel.app)
- 💻 **Source Code Repository**: [https://github.com/prasadaniket/hhgoa_task_2](https://github.com/prasadaniket/hhgoa_task_2) *(Branch: `hhg-main`)*
- ⚡ **Live Benchmark Endpoint**: `POST https://hhg-rag.vercel.app/api/benchmark`
...
```bash
curl -X POST "https://hhg-rag.vercel.app/api/benchmark" \
...
Styling & UI       : Tailwind CSS v4, Lucide Icons, Hacker House Goa Matrix Theme
Fonts              : Space Grotesk (display), Fira Code (mono/code)
Animations         : GSAP 3 (staggered cards) + Canvas Matrix Rain + Palm Tree SVG
...
│   │   │       └── route.ts
│   │   ├── globals.css             # Hacker House Goa theme: neon green, cyan, orange palette
│   │   ├── layout.tsx              # Root HTML with terminal + palm tree favicon & SEO meta
│   │   └── page.tsx                # Main app with HHG_RAG branding & GSAP entrance
│   ├── components/
│   │   ├── InteractiveBg.tsx       # Matrix rain + circuit grid + palm tree silhouettes
│   │   ├── TelemetryProfiler.tsx   # Real-time latency benchmark & health monitor
│   │   ├── VectorExplorer.tsx      # Searchable MongoDB vector chunks browser
...
- [x] **Live Working Demo**: [hhg-rag.vercel.app](https://hhg-rag.vercel.app)
- [x] **Public GitHub Repository**: [https://github.com/prasadaniket/hhgoa_task_2](https://github.com/prasadaniket/hhgoa_task_2) *(Branch: `hhg-main`)*
...
- [x] **Unique Hacker House Goa Theme**: Matrix rain background, neon green/cyan/orange palette, terminal aesthetics with tropical palm tree accents.
...
<div align="center">
  <sub>Built with 🌴 & ⚡ by <strong>Team Probix</strong> for Hacker House Goa 2026 · #RAGInGoa</sub>
</div>
